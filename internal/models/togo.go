...
var Forecasts []Forecast = []Forecast{
	...
	},
	{
		...
		Extended_desc: `Нахождение на последующие дни наиболее вероятного диапазона давлений с учетом тренда.<br />
	...
	},
	{
		...
		Extended_desc: `Нахождение статистически вероятных значений влажности на последующие дни с учетом тренда изменения средних значений влажности.<br />
		Стоит отметить, что метод будет работать исправно лишь при использовании больших значений величины скользящего окна:<br />
		в долгосрочной перспективе учитываются макроизменения, которые зачастую вбирают в себя все микроизменения, чего, очевидно, не происходит в короткосрочных измерениях.<br />
