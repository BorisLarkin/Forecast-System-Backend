INSERT INTO forecasts (id, img_url, title, short, descr, color, measure_type, extended_desc) VALUES
    ...
    (2, 'http://127.0.0.1:9000/test/source_obj/pressure.png', 'Предсказать давление', 'Давление', 
    ...
    (3, 'http://127.0.0.1:9000/test/source_obj/humidity.png', 'Предугадать влажность', 'Влажность', 
